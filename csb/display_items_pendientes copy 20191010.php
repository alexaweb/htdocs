...
<div class="table">
    ...
    <?php foreach ($data_tr as $row):
		?>
			...
			<div class="cell"><a class="button-report" href="edit_item.php?item_id=<?=$row['item_id']?>&item_buque=<?=$row['item_buque']?>&item_descripcion=
			...
			<div class="descriptioncell"><?=$row['si_status']?></div>
			...
			<div class="cell"><?=$row['item_container']?></div>
                        <div class="cell"><a href="display_items_bl_pendientes.php?p_bl=<?=$row['item_bl_awb']?>"><?=$row['item_bl_awb']?></a><a target="_blank" href="<?=$url_carrier?><?=$row['item_bl_awb']?>"><img src="../images/track-icon.png"  alt="Track & Trace" title="Track & Trace" height="15" width="15"></a></div>
